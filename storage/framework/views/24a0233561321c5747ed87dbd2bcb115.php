...
<?php $__env->startSection('title', 'Konfigurasi Data Lembaga'); ?>
...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid">
    ...
    <form action="<?php echo e(route('admin_lembaga.profile.update')); ?>" method="POST" enctype="multipart/form-data"
      id="profile-form">
      <?php echo csrf_field(); ?>
      ...
      <div class="card card-outline card-primary shadow-sm mb-4">
        <div class="card-body p-0 position-relative box-sampul">
          <div class="sampul-container bg-light rounded-top" style="height: 200px; cursor: pointer; overflow: hidden; position: relative;" onclick="document.getElementById('sampul-input').click()">
            <?php if($lembaga->sampul): ?>
              <img src="<?php echo e(Storage::url($lembaga->sampul)); ?>" id="sampul-preview" class="w-100 h-100" style="object-fit: cover;">
            <?php else: ?>
            ...
            <div class="card-body box-profile">
              ...
              <div class="text-center mb-4">
                <div
                  ...
                  <?php if($lembaga->logo): ?>
                    <img src="<?php echo e(Storage::url($lembaga->logo)); ?>" id="logo-preview" class="mw-100 mh-100 object-contain">
                  <?php else: ?>
          ...
          <div class="card card-outline card-success shadow-sm">
            ...
            <div class="card-body pt-0">
              <div class="form-group">
                ...
                <input type="text" name="telepon" value="<?php echo e(old('telepon', $lembaga->telepon)); ?>" class="form-control"
                  placeholder="02xxx-xxx-xxx">
              </div>
              <div class="form-group">
                <label class="small font-weight-bold text-uppercase text-muted">Email Resmi</label>
                <input type="email" name="email" value="<?php echo e(old('email', $lembaga->email)); ?>" class="form-control"
                  placeholder="admin@domain.sch.id">
              </div>
              <div class="form-group">
                <label class="small font-weight-bold text-uppercase text-muted">Website</label>
                <input type="url" name="website" value="<?php echo e(old('website', $lembaga->website)); ?>" class="form-control"
              ...
              <div class="form-group">
                ...
                <textarea name="alamat" rows="4" class="form-control"
                  ...
                  required><?php echo e(old('alamat', $lembaga->alamat)); ?></textarea>
            ...
            <div class="card-body pt-0">
              <div class="row">
                <div class="col-md-8 form-group">
                  ...
                  <input type="text" name="nama_lembaga" value="<?php echo e(old('nama_lembaga', $lembaga->nama_lembaga)); ?>"
                ...
                <div class="col-md-4 form-group">
                  ...
                  <input type="text" name="npsn" value="<?php echo e(old('npsn', $lembaga->npsn)); ?>"
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <select name="status_kepemilikan" class="form-control custom-select">
                    <option value="Yayasan" <?php echo e($lembaga->status_kepemilikan == 'Yayasan' ? 'selected' : ''); ?>>Yayasan
                    </option>
                    <option value="Negeri" <?php echo e($lembaga->status_kepemilikan == 'Negeri' ? 'selected' : ''); ?>>Negeri</option>
                    <option value="Swasta" <?php echo e($lembaga->status_kepemilikan == 'Swasta' ? 'selected' : ''); ?>>Swasta</option>
                    <option value="Lainnya" <?php echo e($lembaga->status_kepemilikan == 'Lainnya' ? 'selected' : ''); ?>>Lainnya
                    </option>
                  </select>
                </div>
                <div class="col-md-6 form-group">
                  ...
                  <select name="akreditasi" class="form-control custom-select">
                    ...
                    <option value="A" <?php echo e($lembaga->akreditasi == 'A' ? 'selected' : ''); ?>>Grade A</option>
                    <option value="B" <?php echo e($lembaga->akreditasi == 'B' ? 'selected' : ''); ?>>Grade B</option>
                    <option value="C" <?php echo e($lembaga->akreditasi == 'C' ? 'selected' : ''); ?>>Grade C</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0">
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="sk_pendirian" value="<?php echo e(old('sk_pendirian', $lembaga->sk_pendirian)); ?>"
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="date" name="tanggal_sk_pendirian"
                    value="<?php echo e(old('tanggal_sk_pendirian', $lembaga->tanggal_sk_pendirian ? $lembaga->tanggal_sk_pendirian->format('Y-m-d') : '')); ?>"
                    class="form-control">
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="sk_izin_operasional"
                    value="<?php echo e(old('sk_izin_operasional', $lembaga->sk_izin_operasional)); ?>" class="form-control"
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="date" name="masa_berlaku_izin"
                    value="<?php echo e(old('masa_berlaku_izin', $lembaga->masa_berlaku_izin ? $lembaga->masa_berlaku_izin->format('Y-m-d') : '')); ?>"
                    class="form-control">
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0">
              <div class="form-group">
                ...
                <textarea name="visi" rows="3" class="form-control font-italic font-weight-bold"
                  placeholder="Contoh: Menjadi lembaga pendidikan yang unggul dan inklusif di masa depan."><?php echo e(old('visi', $lembaga->visi)); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_lembaga', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\perizinan\resources\views/backend/admin_lembaga/profile/index.blade.php ENDPATH**/ ?>