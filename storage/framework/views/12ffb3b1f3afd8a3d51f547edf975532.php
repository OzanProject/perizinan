  ...
  <div class="row mb-4">
    <div class="col-sm-12">
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group">
          <a href="<?php echo e(route('super_admin.laporan.index')); ?>" class="btn btn-primary shadow-sm">
          ...
          <div class="dropdown-menu dropdown-menu-right shadow border-0">
            <a class="dropdown-item" href="<?php echo e(route('super_admin.laporan.export_excel')); ?>"><i
                class="fas fa-file-excel mr-2 text-success"></i> Export Excel</a>
            <a class="dropdown-item" href="<?php echo e(route('super_admin.laporan.export_pdf')); ?>"><i
  ...
  <div class="row">
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-info shadow">
        <div class="inner">
          <h3><?php echo e($stats['total_lembaga']); ?></h3>
          <p>Total Lembaga</p>
        </div>
        <div class="icon">
          <i class="fas fa-university"></i>
        </div>
        <a href="<?php echo e(route('super_admin.lembaga.index')); ?>" class="small-box-footer">Lihat Detail <i
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-warning shadow">
        ...
        <a href="<?php echo e(route('super_admin.perizinan.index')); ?>" class="small-box-footer">More info <i
            class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-success shadow">
        <div class="inner">
          <h3><?php echo e($stats['disetujui']); ?></h3>
          <p>Izin Disetujui</p>
        </div>
        <div class="icon">
          <i class="fas fa-check-circle"></i>
        </div>
        <a href="<?php echo e(route('super_admin.perizinan.index', ['status' => 'DISETUJUI'])); ?>" class="small-box-footer">Lihat
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-danger shadow">
        <div class="inner">
          <h3><?php echo e($stats['perbaikan']); ?></h3>
          <p>Perlu Perbaikan</p>
        </div>
        <div class="icon">
          <i class="fas fa-exclamation-triangle"></i>
        </div>
        <a href="<?php echo e(route('super_admin.perizinan.index', ['status' => 'PERBAIKAN'])); ?>" class="small-box-footer">Lihat
          Detail <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    ...
    <div class="col-md-5">
      <div class="card card-outline card-success shadow">
        ...
        <div class="card-body p-0">
          <div class="table-responsive">
            <table class="table m-0 table-hover">
              ...
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pengajuanTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $perizinan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <tr>
                    ...
                    <td class="align-middle">
                      <div class="d-flex flex-column">
                        ...
                        <small class="text-muted">NPSN: <?php echo e($perizinan->lembaga->npsn); ?></small>
                      </div>
                    </td>
                    <td class="align-middle text-sm text-secondary"><?php echo e($perizinan->jenisPerizinan->nama_jenis); ?></td>
                    <td class="align-middle text-sm">
                      <span class="text-muted"><i class="far fa-calendar-alt mr-1"></i>
                        <?php echo e($perizinan->created_at->format('d M Y')); ?></span>
                    </td>
                    <td class="align-middle">
                      <?php
                      ...
                      ?>
                      <span class="badge <?php echo e($badgeClass); ?> p-2"><?php echo e($statusEnum->label()); ?></span>
                    </td>
                    <td class="align-middle text-right">
                      <a href="<?php echo e(route('super_admin.perizinan.show', $perizinan->id)); ?>"
        ...
        <div class="card-footer clearfix bg-white">
          <a href="<?php echo e(route('super_admin.perizinan.index')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\perizinan\resources\views/backend/super_admin/dashboard.blade.php ENDPATH**/ ?>