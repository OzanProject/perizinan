...
<?php $__env->startSection('title', 'Manajemen Landing Page'); ?>
...
<?php $__env->startSection('content'); ?>
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo e(route('super_admin.dashboard')); ?>">Dashboard</a></li>
  ...
  <section class="content">
    <div class="container-fluid">
      <form action="<?php echo e(route('super_admin.landing_page.update')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="card card-primary card-outline card-outline-tabs">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="hero_title" class="form-control form-control-lg"
                        value="<?php echo e($setting->hero_title); ?>" required>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="hero_subtitle" class="form-control"
                        rows="3"><?php echo e($setting->hero_subtitle); ?></textarea>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="support_text" class="form-control"
                            value="<?php echo e($setting->support_text); ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="support_agents_count" class="form-control"
                            value="<?php echo e($setting->support_agents_count); ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="mb-3">
                        <?php if($setting->hero_image): ?>
                          <img src="<?php echo e(asset('storage/' . $setting->hero_image)); ?>"
                      ...
                      <div class="card-body p-3">
                        ...
                        <div class="form-group mb-0">
                          ...
                          <input type="number" name="stats_rata_hari" class="form-control form-control-sm"
                            value="<?php echo e($setting->stats_rata_hari); ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <div id="license-container">
                      <?php $__currentLoopData = $setting->license_types ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $license): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="row">
                              <div class="col-md-8">
                                <div class="form-group mb-2">
                                  ...
                                  <input type="text" name="license_types[<?php echo e($index); ?>][title]" class="form-control"
                                    value="<?php echo e($license['title']); ?>">
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group mb-2">
                                  <label class="text-xs">Ikon (Material)</label>
                                  <input type="text" name="license_types[<?php echo e($index); ?>][icon]" class="form-control"
                                    value="<?php echo e($license['icon'] ?? 'add_card'); ?>">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group mb-0">
                                  <label class="text-xs">Deskripsi Singkat</label>
                                  <textarea name="license_types[<?php echo e($index); ?>][description]" class="form-control"
                                    rows="2"><?php echo e($license['description']); ?></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="faq_title" class="form-control" value="<?php echo e($setting->faq_title); ?>">
                    </div>
                    <div class="form-group">
                      <label>Sub-judul</label>
                      <input type="text" name="faq_subtitle" class="form-control" value="<?php echo e($setting->faq_subtitle); ?>">
                    </div>
                  ...
                  <div class="col-md-8">
                    ...
                    <div id="faq-container">
                      <?php $__currentLoopData = $setting->faq ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="faq-row card border-left-info mb-3 shadow-sm">
                          <div class="card-body p-3 position-relative">
                            ...
                            <div class="form-group mb-2">
                              ...
                              <input type="text" name="faq[<?php echo e($index); ?>][question]" class="form-control"
                                value="<?php echo e($faq['question']); ?>">
                            </div>
                            <div class="form-group mb-0">
                              <label class="text-xs font-bold uppercase tracking-wider text-muted">Jawaban</label>
                              <textarea name="faq[<?php echo e($index); ?>][answer]" class="form-control"
                                rows="2"><?php echo e($faq['answer']); ?></textarea>
                            </div>
                          </div>
                        </div>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="contact_address" class="form-control"
                        rows="2"><?php echo e($setting->contact_address); ?></textarea>
                    </div>
                    <div class="form-group">
                      <label>Deskripsi Footer</label>
                      <textarea name="footer_description" class="form-control"
                        rows="3"><?php echo e($setting->footer_description); ?></textarea>
                    </div>
                      ...
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="url" name="social_facebook" class="form-control"
                            value="<?php echo e($setting->social_facebook); ?>" placeholder="https://...">
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="url" name="social_instagram" class="form-control"
                            value="<?php echo e($setting->social_instagram); ?>" placeholder="https://...">
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="url" name="social_twitter" class="form-control"
                            value="<?php echo e($setting->social_twitter); ?>" placeholder="https://...">
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="url" name="social_youtube" class="form-control"
                            value="<?php echo e($setting->social_youtube); ?>" placeholder="https://...">
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="card-body p-3">
                        <div class="custom-control custom-switch">
                          <input type="checkbox" name="show_login_button" class="custom-control-input"
                            id="show_login_button_tab" value="1" <?php echo e($setting->show_login_button ? 'checked' : ''); ?>>
          ...
          <div class="card-footer bg-white text-right py-3 border-top">
            <a href="<?php echo e(route('landing')); ?>" target="_blank" class="btn btn-outline-secondary btn-lg mr-2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\perizinan\resources\views/backend/super_admin/landing_page/index.blade.php ENDPATH**/ ?>