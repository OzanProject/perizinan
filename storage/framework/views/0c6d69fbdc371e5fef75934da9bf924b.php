...
<?php $__env->startSection('title', 'Preset & Layout Cetak'); ?>
<?php $__env->startSection('breadcrumb', 'Manajemen Preset'); ?>
    ...
    <div class="row">
      <?php $__empty_1 = true; $__currentLoopData = $presets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card h-100 shadow-sm border-0 border-top <?php echo e($preset->is_active ? 'border-primary' : 'border-light'); ?>"
            style="border-top-width: 4px !important;">
            <div class="card-header bg-white py-3">
              <div class="d-flex justify-content-between align-items-center">
                <h3 class="card-title font-weight-bold text-truncate h5 mb-0" title="<?php echo e($preset->nama); ?>">
                  <?php echo e($preset->nama); ?>
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-4">
                <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center border"
                  ...
                  <span class="text-xs font-weight-bold text-primary"><?php echo e($preset->paper_size); ?></span>
                </div>
                <div class="ml-4 flex-grow-1">
                  <div class="d-flex justify-content-between border-bottom pb-1 mb-2">
                    ...
                    <span class="font-weight-bold small text-dark">
                      <i
                        class="fas <?php echo e(strtolower($preset->orientation) === 'portrait' ? 'fa-arrows-alt-v' : 'fa-arrows-alt-h'); ?> mr-1 text-info"></i>
                      <?php echo e(ucfirst($preset->orientation)); ?>
                  ...
                  <div class="row text-center no-gutters">
                    <div class="col-3">
                      ...
                      <span class="font-weight-bold border rounded px-1"><?php echo e($preset->margin_top); ?></span>
                    </div>
                    <div class="col-3">
                      <label class="text-muted d-block small mb-0" style="font-size: 9px;">BTM</label>
                      <span class="font-weight-bold border rounded px-1"><?php echo e($preset->margin_bottom); ?></span>
                    </div>
                    <div class="col-3">
                      <label class="text-muted d-block small mb-0" style="font-size: 9px;">LFT</label>
                      <span class="font-weight-bold border rounded px-1"><?php echo e($preset->margin_left); ?></span>
                    </div>
                    <div class="col-3">
                      <label class="text-muted d-block small mb-0" style="font-size: 9px;">RGT</label>
                      <span class="font-weight-bold border rounded px-1"><?php echo e($preset->margin_right); ?></span>
                    </div>
                  </div>
                </div>
              </div>
              <p class="text-muted small mb-0"><i class="far fa-clock mr-1"></i> Update:
                <?php echo e($preset->updated_at->translatedFormat('d M Y, H:i')); ?></p>
            </div>

            <div class="card-footer bg-light py-2 d-flex gap-2">
              <?php if(!$preset->is_active): ?>
                <form action="<?php echo e(route('super_admin.penerbitan.preset.set_active', $preset)); ?>" method="POST"
              ...
              <div class="btn-group ml-auto">
                <button type="button" onclick='openPresetModal("edit", <?php echo json_encode($preset, 15, 512) ?>)'
                  class="btn btn-sm btn-default border" title="Edit">
                  <i class="fas fa-edit text-primary"></i>
                </button>
                <?php if(!$preset->is_active): ?>
                  <form action="<?php echo e(route('super_admin.penerbitan.preset.destroy', $preset)); ?>" method="POST"
    ...
    <script>
      function openPresetModal(mode, data = null) {
        ...
        if (mode === 'add') {
          ...
          form.action = "<?php echo e(route('super_admin.penerbitan.preset.store')); ?>";
          ...
          let baseUrl = "<?php echo e(route('super_admin.penerbitan.preset.update', 'ID_PLACEHOLDER')); ?>";
...
<?php echo $__env->make('layouts.backend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\perizinan\resources\views/backend/super_admin/penerbitan/preset.blade.php ENDPATH**/ ?>