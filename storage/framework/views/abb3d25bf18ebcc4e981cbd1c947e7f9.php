<header id="main-header"
  ...
  <div class="flex items-center gap-10 min-w-0">
    <a href="<?php echo e(route('landing')); ?>" class="flex items-center gap-3 text-primary group min-w-0">
      <div
        ...
        <?php if(isset($dinas->logo)): ?>
          <img src="<?php echo e(asset('storage/' . $dinas->logo)); ?>" alt="Logo" class="max-h-6">
        <?php else: ?>
      ...
      <div class="flex flex-col min-w-0">
        <h2
          ...
          <?php echo e($dinas->app_name ?? 'PKBM Licensing'); ?>
        ...
        <span
          ...
          <?php echo e($dinas->footer_text ?? $dinas->nama ?? 'Official Portal'); ?>
    ...
    <nav class="hidden xl:flex items-center gap-8 whitespace-nowrap">
      <a class="text-slate-600 dark:text-slate-400 text-sm font-bold hover:text-primary transition-all relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-primary hover:after:w-full after:transition-all <?php echo e(request()->routeIs('landing') ? 'text-primary after:w-full' : ''); ?>"
        href="<?php echo e(route('landing')); ?>">Beranda</a>
      <a class="text-slate-600 dark:text-slate-400 text-sm font-bold hover:text-primary transition-all relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-primary hover:after:w-full after:transition-all <?php echo e(request()->routeIs('perizinan.jenis') ? 'text-primary after:w-full' : ''); ?>"
        href="<?php echo e(route('perizinan.jenis')); ?>">Jenis Izin</a>
      <a class="text-slate-600 dark:text-slate-400 text-sm font-bold hover:text-primary transition-all relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-primary hover:after:w-full after:transition-all <?php echo e(request()->routeIs('landing.faq') ? 'text-primary after:w-full' : ''); ?>"
        href="<?php echo e(route('landing.faq')); ?>">FAQ</a>
      <a class="text-slate-600 dark:text-slate-400 text-sm font-bold hover:text-primary transition-all relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-primary hover:after:w-full after:transition-all <?php echo e(request()->routeIs('landing.track') ? 'text-primary after:w-full' : ''); ?>"
        href="<?php echo e(route('landing.track')); ?>">Lacak Pengajuan</a>
    </nav>
  </div>
  <div class="flex flex-1 justify-end gap-4 items-center">
    <?php if($setting->show_login_button): ?>
...
<div id="mobile-menu-content"
  ...
  <nav class="flex flex-col gap-6 flex-1 overflow-y-auto custom-scrollbar pr-2">
    <a class="flex items-center justify-between text-lg font-black <?php echo e(request()->routeIs('landing') ? 'text-primary' : 'text-slate-900 dark:text-white'); ?>"
      href="<?php echo e(route('landing')); ?>">
      Beranda <span class="material-symbols-outlined text-slate-400">chevron_right</span>
    </a>
    <a class="flex items-center justify-between text-lg font-black <?php echo e(request()->routeIs('perizinan.jenis') ? 'text-primary' : 'text-slate-900 dark:text-white'); ?>"
      href="<?php echo e(route('perizinan.jenis')); ?>">
      Jenis Izin <span class="material-symbols-outlined text-slate-400">chevron_right</span>
    </a>
    <a class="flex items-center justify-between text-lg font-black <?php echo e(request()->routeIs('landing.faq') ? 'text-primary' : 'text-slate-900 dark:text-white'); ?>"
      href="<?php echo e(route('landing.faq')); ?>">
      FAQ <span class="material-symbols-outlined text-slate-400">chevron_right</span>
    </a>
    <a class="flex items-center justify-between text-lg font-black <?php echo e(request()->routeIs('landing.track') ? 'text-primary' : 'text-slate-900 dark:text-white'); ?>"
      href="<?php echo e(route('landing.track')); ?>">
  ...
  <div class="mt-auto pt-8 border-t border-slate-100 dark:border-slate-800 flex flex-col gap-4">
    ...
    <?php endif; ?>
    <p class="text-center text-[10px] text-slate-400 uppercase font-bold tracking-widest mt-2">© <?php echo e(date('Y')); ?>

      <?php echo e($dinas->nama); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\laragon\www\perizinan\resources\views/public/partials/header.blade.php ENDPATH**/ ?>