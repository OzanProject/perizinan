...
<?php $__env->startSection('title', $setting->hero_title); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
            <div class="flex flex-col gap-6 md:gap-8 flex-1 w-full">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-4" data-aos="fade-up" data-aos-delay="400">
                    <a href="<?php echo e(route('perizinan.jenis')); ?>"
                    ...
                    <a href="<?php echo e(route('landing.track')); ?>"
                ...
                <div class="flex flex-col gap-4 mt-8" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="marquee-container">
                        <div class="marquee-content">
                            ...
                            <?php $combinedLogos = $lembagaLogos->concat($lembagaLogos)->concat($lembagaLogos); ?>
                            <?php $__currentLoopData = $combinedLogos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    ...
                                    <div
                                        ...
                                        <img class="w-full h-full object-cover" src="<?php echo e(asset('storage/' . $l->logo)); ?>"
                                            alt="<?php echo e($l->nama_lembaga); ?>">
                                    </div>
                                    <span
                                        class="text-sm font-bold text-slate-700 dark:text-slate-300 whitespace-nowrap"><?php echo e($l->nama_lembaga); ?></span>
                                </div>
            ...
            <div class="flex-1 w-full relative" data-aos="fade-left" data-aos-duration="1200">
                ...
                <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/20">
                    <?php if($setting->hero_image): ?>
                        <img class="w-full h-full object-cover" src="<?php echo e(asset('storage/' . $setting->hero_image)); ?>" alt="Hero">
                    <?php else: ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-24 bg-white dark:bg-slate-900" id="licenses">
        <div class="text-center mb-16" data-aos="fade-up">
            <div
                ...
                <?php echo e($setting->license_title ?? 'JENIS IZIN TERSEDIA'); ?>

            </div>
            <h3 class="text-3xl md:text-5xl font-black text-slate-900 dark:text-white mb-6 tracking-tighter">
                <?php echo e($setting->license_subtitle ?? 'Pilih Jenis Perizinan Anda'); ?>

            </h3>
            <p class="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed">
                <?php echo e($setting->license_description ?? 'Sistem kami mendukung berbagai kategori perizinan sesuai dengan kebutuhan operasional lembaga Anda.'); ?>
                ...
                <div class="group relative bg-slate-50 dark:bg-slate-800/50 rounded-[2.5rem] p-8 border border-slate-100 dark:border-slate-700 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5"
                    ...
                    <div class="flex justify-between items-start mb-8">
                        <div
                            ...
                            <span class="material-symbols-outlined text-3xl"><?php echo e($license['icon'] ?? 'add_card'); ?></span>
                        </div>
                        <?php if(isset($license['badge'])): ?>
                            <span
                                class="px-3 py-1 rounded-full bg-primary/10 text-primary text-[10px] font-black uppercase tracking-wider">
                                <?php echo e($license['badge']); ?>
    ...
    <section class="max-w-4xl mx-auto px-4 py-20" id="faq">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-primary font-bold tracking-widest text-sm mb-4"><?php echo e($setting->faq_title ?? 'PUSAT PENGETAHUAN'); ?>

            </h2>
            <h3 class="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white">
                <?php echo e($setting->faq_subtitle ?? 'Pertanyaan yang Sering Diajukan'); ?>

            </h3>
        </div>
        <div class="space-y-4">
            <?php $__currentLoopData = $setting->faq ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="faq-item bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm"
                    ...
                    <div class="p-6 flex items-center justify-between cursor-pointer"
                        ...
                        <h5 class="font-bold text-slate-900 dark:text-white pr-4"><?php echo e($item['question']); ?></h5>
                        <span
    ...
    <script>
        $(document).ready(function () {
            $('#track-btn').click(function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('track.check')); ?>",
                    method: "GET",
                    data: { id: trackingId },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\perizinan\resources\views/public/landing.blade.php ENDPATH**/ ?>