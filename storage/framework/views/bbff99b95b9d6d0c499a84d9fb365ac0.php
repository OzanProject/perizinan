...
<head>
    ...
    <title>Login | <?php echo e($globalDinas->app_name ?? 'Sistem Perizinan'); ?></title>
    <?php if(isset($globalDinas) && $globalDinas->logo): ?>
    ...
    <div class="w-full max-w-md relative">
            ...
            <div class="p-8 md:p-10">
                ...
                <div class="text-center mb-10">
                    <?php if(isset($globalDinas) && $globalDinas->logo): ?>
                        <div
                            ...
                            <img src="<?php echo e(Storage::url($globalDinas->logo)); ?>" alt="Logo" class="w-16 h-16 object-contain">
                        </div>
                    <?php endif; ?>
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm font-medium">
                        Silakan masuk ke akun <?php echo e($globalDinas->app_name ?? 'Portal Perizinan'); ?> Anda
                    </p>
                </div>
                ...
                <?php if($errors->any()): ?>
                    <div
                        ...
                        <span class="text-red-700 dark:text-red-400 text-sm font-medium"><?php echo e($errors->first()); ?></span>
                    </div>
                <?php endif; ?>
        ...
        <div class="mt-8 text-center animate-pulse">
            <p class="text-white/40 text-[10px] font-bold uppercase tracking-[0.3em]">
                © <?php echo e(date('Y')); ?> <?php echo e($globalDinas->footer_text ?? $globalDinas->nama ?? 'Dinas Pendidikan Kota'); ?>
...
</html><?php /**PATH D:\laragon\www\perizinan\resources\views/auth/login.blade.php ENDPATH**/ ?>