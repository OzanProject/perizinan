  ...
  <div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20">
      ...
      <div class="lg:col-span-4 flex flex-col gap-8 min-w-0">
        <a href="<?php echo e(route('landing')); ?>" class="flex items-center gap-3 text-white group min-w-0">
          <div
            ...
            <?php if(isset($dinas->logo)): ?>
              <img src="<?php echo e(asset('storage/' . $dinas->logo)); ?>" alt="Logo" class="max-h-8">
            <?php else: ?>
          ...
          <div class="flex flex-col min-w-0">
            ...
            <p class="text-[9px] md:text-[10px] uppercase tracking-[0.2em] font-black text-slate-500 leading-relaxed">
              <?php echo e($dinas->nama ?? 'Official Portal'); ?>

            </p>
          </div>
        </a>
        <p class="text-slate-400 leading-relaxed text-sm max-w-sm">
          <?php echo e($setting->footer_description ?? 'Portal Informasi Perizinan PKBM Terpadu. Memastikan keunggulan pendidikan melalui layanan perizinan yang transparan dan mudah diakses.'); ?>

        </p>
        <div class="flex flex-wrap gap-3">
          <?php if($setting->contact_email): ?>
            <a href="mailto:<?php echo e($setting->contact_email); ?>" title="Email"
          ...
          <?php if($setting->contact_phone): ?>
            <a href="tel:<?php echo e($setting->contact_phone); ?>" title="Phone"
              class="size-11 rounded-2xl bg-slate-800/50 border border-slate-700/50 flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300 group">
          ...
          <?php if($setting->social_facebook): ?>
            <a href="<?php echo e($setting->social_facebook); ?>" target="_blank" title="Facebook"
          ...
          <?php if($setting->social_instagram): ?>
            <a href="<?php echo e($setting->social_instagram); ?>" target="_blank" title="Instagram"
          ...
          <?php if($setting->social_twitter): ?>
            <a href="<?php echo e($setting->social_twitter); ?>" target="_blank" title="Twitter / X"
          ...
          <?php if($setting->social_youtube): ?>
            <a href="<?php echo e($setting->social_youtube); ?>" target="_blank" title="YouTube"
        ...
        <div>
          ...
          <ul class="space-y-6 text-sm">
            <li class="flex items-start gap-4 group">
              ...
              <span
                class="flex-1 font-medium group-hover:text-slate-300 transition-colors"><?php echo e($setting->contact_address ?? 'Gedung Dinas Pendidikan'); ?></span>
            </li>
            <li class="flex items-start gap-4 group">
              <div
                class="size-8 rounded-lg bg-slate-800 flex items-center justify-center text-primary border border-slate-700 group-hover:bg-primary group-hover:text-white transition-all">
              ...
              <span
                class="flex-1 font-medium group-hover:text-slate-300 transition-colors"><?php echo e($setting->contact_phone); ?></span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="lg:col-span-4">
        ...
        <div
          ...
          <?php if($setting->google_maps_embed): ?>
            <?php echo $setting->google_maps_embed; ?>
    ...
    <div class="border-t border-slate-800/50 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
      <div class="flex flex-col md:flex-row items-center gap-2 md:gap-4">
        <p class="text-[10px] uppercase font-black tracking-widest text-slate-500/80">
          © <?php echo e(date('Y')); ?> <?php echo e($dinas->footer_text ?? $dinas->nama); ?>
...
</style><?php /**PATH D:\laragon\www\perizinan\resources\views/public/partials/footer.blade.php ENDPATH**/ ?>