...
<style>
    .finalisasi-wrapper {
        display: flex;
        flex-direction: row;
        height: calc(100vh - 57px - 57px); /* Adjust based on header/footer height */
        overflow: hidden;
    }
    .left-panel {
        width: 400px;
...
@section('content')
<form id="penerbitan-form" action="{{ route('super_admin.perizinan.release', $perizinan) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="finalisasi-wrapper">
        ...
        <div class="left-panel">
            ...
            <div class="form-group mb-4">
                <label class="font-weight-bold small text-muted text-uppercase mb-2">Nomor Registrasi SK <span class="text-danger">*</span></label>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group mb-4">
                        ...
                        <select id="masa_berlaku" name="masa_berlaku" class="form-control custom-select" onchange="updatePreview()">
                            @php 
        ...
        <div class="right-panel">
            <div class="bg-white border-bottom py-2 px-4 d-flex justify-content-between align-items-center shadow-sm" style="z-index: 5;">
                ...
                <div class="btn-group">
                    ...
                    <span class="btn btn-light btn-sm border-top border-bottom px-3 font-weight-bold" id="zoom-level">85%</span>
                    <button type="button" class="btn btn-light btn-sm border" onclick="zoomPreview(0.1)"><i class="fas fa-plus"></i></button>
                </div>
            </div>

            <div class="preview-container">
                <div id="preview-paper" class="scale-85">
...
<script>
    ...
    function updatePreview() {
        // Here we could implement live text replacement for common markers
        // But since the template can be arbitrary HTML, we mostly rely on re-renders 
        // Or specific target markers if they exist in the template.
    }
