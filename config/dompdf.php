...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var string
         */
        // Gunakan Times-Roman (PDF Base 14 Font) bukan 'serif' yang bergantung pada font sistem.
        // Times-Roman dijamin identik di semua platform (Windows, Linux, Mac) karena
        // ia adalah font bawaan yang sudah ter-embed di setiap PDF viewer — tidak memerlukan
        // font fisik dari sistem operasi, sehingga tidak ada selisih rendering antar server.
